"""Bing API client combining all sub-clients.

This module provides the main BingClient class that serves as the
entry point for all Bing API operations.
"""
...
class BingClient:
    """Client for all Bing API operations.

    This class provides access to all Bing scraping endpoints through
    ...
    Note:
        ...
        the `bing` property of the main `ScrapeBadger` client.
    """

    def __init__(self, client: BaseClient) -> None:
        """Initialize Bing client with all sub-clients.
    ...
    def search(self) -> SearchClient:
        ...
        Example:
            ...
            suggestions = await client.bing.search.autocomplete("lapt")
            ```
        """
        return self._search
    ...
    def media(self) -> MediaClient:
        ...
        Returns:
            MediaClient for Bing image search and video search.
    ...
    def news(self) -> NewsClient:
        ...
        Returns:
            NewsClient for the Bing news vertical.

        Example:
            ```python
            news = await client.bing.news.news("ai", freshness="week")
            ```
        """
        return self._news
    ...
    def reference(self) -> ReferenceClient:
        ...
        Returns:
            ReferenceClient for fetching the supported Bing markets.
