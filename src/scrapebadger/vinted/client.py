...
class VintedClient:
    ...
    async def list_public_vinted_mobile_operations(self) -> dict[str, Any]:
        """List public Vinted mobile operations.

        Generated from the OpenAPI spec; returns the raw response dict.
        """
        return await self._client.get("/v1/vinted/mobile/operations")

    async def read_vinted_mobile_data(
        self,
        operation: str,
        *,
        ...
        return await self._client.post(
            f"/v1/vinted/mobile/{operation}", params=params, json=payload
        )
    ...
    async def search_by_image(
        ...
        Generated from the OpenAPI spec; returns the raw response dict.
        """
        return await self._client.post("/v1/vinted/search_by_image", params=params, json=payload)
